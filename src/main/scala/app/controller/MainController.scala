...
object Main extends App {  
  ...
  val NUMBER_OF_CUSTOMERS: Int = 2000
  val NUMBER_OF_PRODUCTS: Int = 2000
  val NUMBER_OF_ORDERS: Int = 400
  ...
  StockKeeperManager.newKeeper("Vasco",new TimeBox("2019-01-01","2019-12-31"),new TimeFrames(Array("1-6","7-12","13-24",">24")))
